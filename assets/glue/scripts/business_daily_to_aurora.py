...
## @params: [TempDir, JOB_NAME, db_name, aurora_connection, temp_workflow_bucket]
args = getResolvedOptions(sys.argv, ['TempDir','JOB_NAME', 'db_name', 'aurora_connection', 'temp_workflow_bucket'])
