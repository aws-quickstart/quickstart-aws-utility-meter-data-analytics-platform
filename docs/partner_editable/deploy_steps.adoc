...
[cols=",]
|===
|https://fwd.aws/5Pj8e[Deploy {partner-product-name} into a new VPC on AWS^] 
|https://fwd.aws/zejvg[Deploy {partner-product-name} into an existing VPC on AWS^]
|===
...
//TODO Shivansh, How much of the warning above applies to this Quick Start?
...
. On the *Specify stack details* page, change the stack name if needed. Review the parameters for the template. Provide values for the parameters that require input. For all other parameters, review the default settings and customize them as necessary. See the "Parameter reference" section.

//TO DO Shivansh, How do we add a link to "Parameter reference" in the previous sentence? (After we add the link, we'll remove the quotation marks.)
