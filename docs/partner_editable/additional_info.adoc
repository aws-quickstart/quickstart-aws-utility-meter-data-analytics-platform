...
=== Prepare weather data if you want to use it for training
...
```
+
image::../images/4_create_weather_table.png

If you have other weather dataset you want to use, make sure it contains at least below 4 columns.
```sql
...
include::../{specificdir}/ml_pipeline.adoc[]

== Data schema and API i/o format
include::../{specificdir}/data_format.adoc[]