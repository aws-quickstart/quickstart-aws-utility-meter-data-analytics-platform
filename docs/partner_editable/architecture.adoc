...
If you choose to deploy special data adapters, the Quick Start will deploy the following additional resources. They are depicted in <<architecture_adapter1>> in the "Modular CloudFormation adapter substack" group (shaded).
